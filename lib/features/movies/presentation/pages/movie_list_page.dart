...
/// Full-screen movie list for a specific category/genre
...
class _MovieListPageState extends ConsumerState<MovieListPage> {
  ...
  void initState() {
    super.initState();
    _provider = movieListProvider(widget.category, genreId: widget.genreId);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: state.movies.isEmpty && state.isLoading
          ? const Center(
              child: CircularProgressIndicator(color: AppTheme.primary))
          : state.movies.isEmpty && state.error != null
              ? ErrorView(
                  message: state.error!,
